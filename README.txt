This is a Django Log File parser app.

Useful to add log files view functionality to your Django web site.
Instead of using database log files storage, it gives you ability to store/view log files through GUI.
It requires a directory with Django log files inside. E.g.:
...
urlpatterns = patterns('',
    ...
    url(r'', include('django_log_file_viewer.urls')),
)



Reference:
    Info on how to add/config logging for your Django based website here:
    https://docs.djangoproject.com/en/dev/topics/logging/ (Official Django documentation)
    Parsing/testing Regexp is useful with:
